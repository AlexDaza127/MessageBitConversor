...
public class StatisticalStructureMessage {
    ...
    public String triggerStatisticalStructure(String content, String type) {
        if (content != null) {
            ...
            processData.append("cantidad total probabilidad de simbolos contados = " + df.format(contTotalEntropy).replace(",", "."));
    ...
    /**
     * Organiza las llaves de los hashmap, así se obtiene el simbolo que mas
