...
public class StatisticalStructureMessage {
	...
	/**
	 * Organiza las llaves de los hashmap, así se obtiene el simbolo que mas aparece del mayor a menor en el contenido del mensaje
	 * @param <K> key
	 * @param <V> value
	 * @param map hashmap
	 * @param value valor
	 ...
	 * @param probabilitySymbol porcentaje de probabilidad de aparición de los simbolos
